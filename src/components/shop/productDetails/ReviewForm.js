...
const ReviewForm = () => {
    ...
    if (productData.error || productData.success) {
        setTimeout(() => {
            setproductData({ ...productData, error: false, success: false });
        }, 3000);
    }
    ...
    return (
        <Fragment>
            <div className="md:mx-16 lg:mx-20 xl:mx-24 flex flex-col">
                {productData.error ? Alert('red', productData.error) : ''}
                {productData.success ? Alert('green', productData.success) : ''}
            </div>
                ...
                <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 flex flex-col">
                    ...
                    <div className="space-y-4">
                        <div className="flex flex-col">
                            ...
                            <textarea
                                onChange={(e) => setproductData({ ...productData, review: e.target.value })}
                        ...
                        <div
                            onClick={(e) => reviewSubmitHanlder(productData, setproductData, fetchData)}
